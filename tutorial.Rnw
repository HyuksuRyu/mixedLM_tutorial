...
{\includegraphics[height=.69cm]{figure/lab_logo_white.pdf}};
%\node[anchor=north east, yshift=-12.5pt] at (current page.north east) {\includegraphics[height=.69cm]{figure/lab_logo_blue2.pdf}};
\end{tikzpicture}}
...
\subtitle[Samsung]{Samsung Interview}
...
\institute[Seoul Nat'l Univ.]{\inst{1} Department of Linguistics, Seoul National University, Seoul, Korea}
%\institute{National Institute of Korean Lanugage, Seoul, Korea}
%\institute{NAVER Corporation, Seongnam, Korea}
\titlegraphic{
	\includegraphics[height=.4cm]{figure/SNU_logo_lr.pdf}
	%\hspace*{2cm}
	%\includegraphics[height=.4cm]{figure/Korean_logo_eng.pdf}
	%\hspace*{2cm}
	%\includegraphics[height=.4cm]{figure/Naver_logo.pdf}
	%\includegraphics[height=.4cm]{figure/mindslab_logo.png}
	}
